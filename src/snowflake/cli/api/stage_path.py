...
class StagePath:
    ...
    # @classmethod
    # def _process_stage_name(cls, stage_name: str) -> str:
    #     if stage_name
    @classmethod
    def from_stage_str(cls, stage_str: str | FQN):
        ...
        if len(parts) == 2:
            ...
            path = None
        return cls(stage_name=stage_string, path=path)
    ...
    def from_git_str(cls, git_str: str):
        ...
        """
        repo_name, git_ref, path = cls._split_repo_path(git_str)
        return cls(stage_name=repo_name, path=path, git_ref=git_ref)
    ...
    def joinpath(self, path: str) -> StagePath:
        ...
        return StagePath(
            ...
            path=PurePosixPath(self._path) / path,
