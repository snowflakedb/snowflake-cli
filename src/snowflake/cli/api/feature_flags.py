...
class FeatureFlag(FeatureFlagMixin):
    ...
    ENABLE_DCM_PLAN_DELTA = BooleanFlag("ENABLE_DCM_PLAN_DELTA", False)
    ...
    ENABLE_SPCS_REMOTE_BUILD = BooleanFlag("ENABLE_SPCS_REMOTE_BUILD", False)
    ENABLE_DBT_PROJECT_ENV_VARS = BooleanFlag("ENABLE_DBT_PROJECT_ENV_VARS", False)
    ENABLE_DBT_PROJECT_PROFILES_FILE_PRECEDENCE = BooleanFlag(
        "ENABLE_DBT_PROJECT_PROFILES_FILE_PRECEDENCE", False
    )
