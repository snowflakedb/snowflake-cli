...
class FeatureFlag(FeatureFlagMixin):
    ...
    ENABLE_SNOWPARK_SKIP_DEPENDENCIES = BooleanFlag(
        "ENABLE_SNOWPARK_SKIP_DEPENDENCIES", False
    )
    ENABLE_SNOWPARK_ARTIFACT_REPOSITORY_REQUIREMENTS = BooleanFlag(
        "ENABLE_SNOWPARK_ARTIFACT_REPOSITORY_REQUIREMENTS", False
    )
    ...
    ENABLE_STREAMLIT_UBAC_SHARING = BooleanFlag("ENABLE_STREAMLIT_UBAC_SHARING", False)
