...
from snowflake.cli.plugins.containers import plugin_spec as containers_plugin_spec
...
from snowflake.cli.plugins.registry import plugin_spec as registry_plugins_spec
