...
class DownloadUnavailablePackagesResult:
    ...
    packages_available_in_snowflake: List[Requirement] = dataclasses.field(
...
def download_unavailable_packages(
    ...
    - packages_available_in_snowflake - list of omitted packages
    ...
    split_requirements = packages_available_in_snowflake.filter_available_packages(
    ...
    if not requirements:
        ...
        return DownloadUnavailablePackagesResult(
            succeeded=True,
            packages_available_in_snowflake=omitted_packages,
        )
    ...
    with Venv() as v, SecurePath.temporary_directory() as downloads_dir:
        ...
        split_dependencies = packages_available_in_snowflake.filter_available_packages(
