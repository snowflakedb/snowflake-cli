...
def test_services(_test_steps: Tuple[SnowparkServicesTestSteps, str]):
    ...
    test_steps.metrics_should_include_services_from_both_dbs(service_name, "hello-world")
    test_steps.metrics_with_fqn_should_include_only_one_service(service_name, test_steps.database, "hello-world")
    test_steps.metrics_with_fqn_should_include_only_one_service(service_name, test_steps.another_database, "hello-world")
