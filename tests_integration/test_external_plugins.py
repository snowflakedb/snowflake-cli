...
def test_loading_of_installed_plugins_if_all_plugins_enabled(
    ...
    assert_that_result_is_successful(result_of_top_level_help, caplog)
    ...
    assert_that_result_is_successful(result_of_multilingual_hello_help, caplog)
    ...
    assert_that_result_is_successful(result_of_multilingual_hello_fr_help, caplog)
    ...
    assert_that_result_is_successful(result_of_snowpark_help, caplog)
    ...
    assert_that_result_is_successful(result_of_snowpark_hello_help, caplog)
