...
from tests_integration.testing_utils.snowpark_utils import SnowparkTestSetup, TestType, SnowparkTestSteps
...
def test_procedure_coverage_flow(_test_steps):
    ...
    procedure_name = _test_steps.snowpark_create_with_coverage_wrapper_should_finish_succesfully()
