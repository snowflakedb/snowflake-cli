...
Copied from the Snowflake monorepo at
`Snowfort/tests/snowpark/code_bundle/data/code_bundle_scos_jvm_wh`. Keep them in
sync by hand if that directory's apps change — nothing automated links them.
