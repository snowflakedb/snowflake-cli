...
@pytest.fixture
def project_definition_files(request, project_dir) -> Generator[List[Path], None, None]:
    """
    ...
    with snowflake_ymls(project_dir, dir_name) as ymls:
        yield ymls
