...
def test_format(runner, custom_snapshot):
...
def test_mutually_exclusive_options_error(custom_snapshot):
    app = Typer()
...
def test_overrideable_option_callback_with_mutually_exclusive(custom_snapshot):
    """
