...
deploy_root = Path("output") / "deploy" / "streamlit"
...
@pytest.mark.parametrize(
    ...
    [
        (
            "src",
            [
                {"local": deploy_root / "src" / "app.py", "stage": "/src"},
                {
                    "local": deploy_root / "src" / "dir" / "dir_app.py",
                    "stage": "/src/dir",
                },
            ],
        ),
        ...
        ("src/*.py", [{"local": deploy_root / "src" / "app.py", "stage": "/src"}]),
        (
            "src/dir/dir_app.py",
            [
                {
        ...
        (
            {"src": "src/**/*", "dest": "source/"},
            [
                {"local": deploy_root / "source" / "app.py", "stage": "/source"},
                {"local": deploy_root / "source" / "dir_app.py", "stage": "/source"},
                {
                    "local": deploy_root / "source" / "dir" / "dir_app.py",
                    "stage": "/source/dir",
                },
            ],
        ),
        (
            ...
            [
                {
                    "local": deploy_root / "source" / "src" / "app.py",
                    "stage": "/source/src",
                },
                {
                    "local": deploy_root / "source" / "src" / "dir" / "dir_app.py",
        ...
        (
            ...
            [
                {
                    "local": deploy_root / "source" / "dir" / "apps" / "dir_app.py",
