...
from snowcli.plugins.containers.compute_pool.manager import ComputePoolManager
...
class TestComputePoolManager(unittest.TestCase):
    ...
    @patch(
        "snowcli.plugins.containers.compute_pool.manager.ComputePoolManager._execute_query"
    )
